...
class home extends React.Component<Props, State> {
  ...
  popularList = ['拉菲珍宝红葡萄酒', '赤霞珠', '尝得到的一级庄韵', '法国拉菲传奇', '红酒之夜', '拉菲珍宝红葡萄酒', '尝得到的一级庄韵', '法国拉菲传奇', '法国拉菲传奇', '拉菲珍宝红葡萄酒']
  historyList = ['千红', '红葡萄酒', '千百', '飞粉色千红', '红葡萄酒', '千百']
      ...
      <div className="p-home">
        ...
        <div className="main">
          <div className="hot-search">
            ...
            <ul>
              {
                this.popularList.map((item, index) => {
